...
alias ll='ls -laF' # long listing format
...
#Install a package
alias installapp='sudo pacman -S'
#Remove a package and it
alias removeapp='sudo pacman -Rs'
...
#	# External IP Lookup
	...
	echo -n "External IP: " ; wget https://smart-ip.net/myip -O - -q
}
